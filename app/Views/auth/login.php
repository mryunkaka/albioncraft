...
<body class="page">
  <main class="container">
    <header class="page-header">
      ...
      <p class="page-subtitle">Masuk untuk menyimpan histori dan mengelola fitur subscription.</p>
    </header>
    ...
    <section class="card auth-card">
      ...
      <form method="post" action="/login" class="form">
        ...
        <div class="actions auth-actions">
          <a class="button button-ghost" href="/register">Belum punya akun? Register</a>
